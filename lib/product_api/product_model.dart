...
ProductModel dataFromJsonBuy(String str) =>
...
class Dimensions {
  ...
  Dimensions.fromJson(Map<String, dynamic> json) {
    width = json['width']?.toDouble(); // Handle conversion to double
    height = json['height']?.toDouble(); // Handle conversion to double
    depth = json['depth']?.toDouble(); // Handle conversion to double
  }
